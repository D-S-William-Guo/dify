...
- 当前官方稳定发布基线：`1.14.1` tag/tree
- 当前企业候选分支：`codex/enterprise-candidate-1.14.1-20260514`
- 当前企业版本：`1.14.1-enterprise`
- 正式企业镜像：
  - `dify-api-enterprise:1.14.1-enterprise`
  - `dify-web-enterprise:1.14.1-enterprise`
...
head: D-S-William-Guo/dify:codex/enterprise-candidate-1.14.1-20260514
```
...
- `codex/enterprise-candidate-1.14.1-20260514`：当前最佳企业候选分支，基于官方 `1.14.1` tag/tree。
...
旧候选中的 DSL、configuration hook、workflow、plugin、dataset、tool 等广覆盖补丁，必须先对比官方 `1.14.1`，确认官方没有等价修复且企业能力仍需要后，才允许最小重放。
...
```powershell
git clone https://github.com/langgenius/dify.git D:\CodexSpace\dify-enterprise-1.14.1-candidate-20260514
cd D:\CodexSpace\dify-enterprise-1.14.1-candidate-20260514
git remote rename origin upstream
git remote add origin https://github.com/D-S-William-Guo/dify.git
git fetch upstream tag 1.14.1
git switch -c codex/enterprise-candidate-1.14.1-20260514 1.14.1
```

如果工作树已经存在，应先确认目录内容，不得删除未知文件。当前候选已从 `refs/tags/1.14.1` 创建。
...
- 官方版本：`1.14.1`
- 企业版本：`1.14.1-enterprise`
- API 镜像：`dify-api-enterprise:1.14.1-enterprise`
- Web 镜像：`dify-web-enterprise:1.14.1-enterprise`

`worker` 与 `worker_beat` 运行时继续复用 `dify-api-enterprise:1.14.1-enterprise`。
