...
- Official stable tag/tree `1.14.1` is the current enterprise release baseline.
- `codex/enterprise-candidate-1.14.1-20260514` is the current clean enterprise candidate.
...
- Official version: `1.14.1`
- Enterprise version: `1.14.1-enterprise`
- API image: `dify-api-enterprise:1.14.1-enterprise`
- Web image: `dify-web-enterprise:1.14.1-enterprise`
...
```powershell
$env:DIFY_ENTERPRISE_VERSION = "1.14.1-enterprise"
```
...
- After rebuilding `dify-api-enterprise:1.14.1-enterprise`, recreate `api`, `worker`, `worker_beat`, and `nginx`:
...
- After rebuilding `dify-web-enterprise:1.14.1-enterprise`, recreate `web` and `nginx`:
...
export DIFY_ENTERPRISE_VERSION=1.14.1-enterprise
...
Do not rebuild during final packaging after runtime validation. `Mode=reuse` should fail if `dify-api-enterprise:1.14.1-enterprise` or `dify-web-enterprise:1.14.1-enterprise` is missing or inconsistent.
