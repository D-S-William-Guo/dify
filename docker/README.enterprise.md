...
- Official version: `1.14.0`
- Enterprise version: `1.14.0-enterprise`
- API image: `dify-api-enterprise:1.14.0-enterprise`
- Web image: `dify-web-enterprise:1.14.0-enterprise`
...
Do not rebuild during final packaging after runtime validation. `Mode=reuse` should fail if `dify-api-enterprise:1.14.0-enterprise` or `dify-web-enterprise:1.14.0-enterprise` is missing or inconsistent.
