...
class EnterpriseMarketplaceAssetListApi(Resource):
    ...
    @account_initialization_required
    def get(self):
        args = EnterpriseMarketplaceListQuery.model_validate(request.args.to_dict(flat=True))  # type: ignore[arg-type]
...
class PlatformAdminEnterpriseMarketplaceAssetListApi(Resource):
    ...
    @platform_admin_required
    def get(self):
        args = PlatformAdminEnterpriseMarketplaceListQuery.model_validate(request.args.to_dict(flat=True))  # type: ignore[arg-type]
