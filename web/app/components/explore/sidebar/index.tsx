    ...
    <div className={cn('flex h-full w-fit shrink-0 cursor-pointer flex-col px-3 pt-6 sm:w-[240px]', isFold && 'sm:w-[56px]')}>
      ...
      <div className={cn('mt-1', isMarketplaceSelected ? 'text-text-accent' : 'text-text-tertiary')}>
        ...
        >
          ...
          {!isMobile && !isFold && <div className={cn('truncate', isMarketplaceSelected ? 'text-components-menu-item-text-active system-sm-semibold' : 'text-components-menu-item-text system-sm-regular')}>{t('enterpriseMarketplace.sidebarTitle', { ns: 'common' })}</div>}
        </Link>
      </div>
