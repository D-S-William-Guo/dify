...
export const MAIN_NAV_ROUTES = [
  ...
  },
  {
    ...
    active: (path: string) => isPathUnderRoute(path, '/platform-admin/workspaces'),
    icon: 'i-ri-admin-line',
    activeIcon: 'i-ri-admin-fill',
    visibility: 'platformAdmin',
  },
  {
    key: 'enterprise-marketplace-review',
    href: '/platform-admin/enterprise-marketplace',
    labelKey: 'enterpriseMarketplace.review.title',
    active: (path: string) => isPathUnderRoute(path, '/platform-admin/enterprise-marketplace'),
    icon: 'i-ri-store-2-line',
    activeIcon: 'i-ri-store-2-fill',
    visibility: 'platformAdmin',
  },
