...
import type { EnterpriseMarketplaceAsset, EnterpriseMarketplaceAssetStatus } from '@/models/common'
...
const ReviewDialog = ({
  ...
  useEffect(() => {
    if (asset && action)
      setReviewNote(asset.review_note || '')
  }, [action, asset])
      ...
      <DialogContent className="max-w-[560px] p-0">
        ...
        <div className="space-y-3 px-6 pb-4">
          <div className="rounded-xl border border-divider-subtle bg-background-body p-4">
            <div className="text-text-primary system-sm-semibold">{asset.title}</div>
    ...
    <>
      <div className="rounded-2xl border border-divider-subtle bg-components-panel-bg p-4">
        <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <div className="text-text-primary title-lg-semi-bold">
        ...
        {status === 'pending' && reviewableAssets.length > 0 && (
          <div className="mb-4 rounded-xl border border-divider-subtle bg-background-body px-4 py-3 text-text-secondary system-sm-regular">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="truncate text-text-primary title-md-semi-bold">{item.title}</div>
                    <span className="rounded-full bg-background-default px-2 py-1 text-text-tertiary system-2xs-medium-uppercase">
                  ...
                  {!!item.scenario && (
                    <div className="mt-3 rounded-xl border border-divider-subtle bg-components-panel-bg p-3 text-text-tertiary system-xs-regular">
                      {item.scenario}
                    </div>
                  )}
                  {!!item.review_note && (
