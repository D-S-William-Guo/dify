...
const EnterpriseMarketplaceAdmin = () => {
  ...
  const getStatusLabel = (status: EnterpriseMarketplaceAssetStatus) => {
    switch (status) {
      case 'pending':
        return t(($) => $["enterpriseMarketplace.status.pending"], { ns: 'common' })
      case 'approved':
        return t(($) => $["enterpriseMarketplace.status.approved"], { ns: 'common' })
      case 'rejected':
        return t(($) => $["enterpriseMarketplace.status.rejected"], { ns: 'common' })
      case 'unlisted':
        return t(($) => $["enterpriseMarketplace.status.unlisted"], { ns: 'common' })
    }
  }
