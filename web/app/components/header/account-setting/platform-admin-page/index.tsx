              ...
              {selectedWorkspace && (
                <>
                  ...
                  <div className="overflow-hidden rounded-lg border border-divider-subtle">
                    <div className="grid grid-cols-[minmax(0,1.4fr)_160px_96px] border-b border-divider-subtle bg-background-body px-4 py-3 system-xs-medium-uppercase text-text-tertiary">
                      <div>{t('members.name', { ns: 'common' })}</div>
                      <div>{t('members.role', { ns: 'common' })}</div>
                      <div>{t('operation.delete', { ns: 'common' })}</div>
                    </div>
                    {members.map(member => (
                      <div key={member.id} className="grid grid-cols-[minmax(0,1.4fr)_160px_96px] items-center border-b border-divider-subtle px-4 py-3 last:border-b-0">
