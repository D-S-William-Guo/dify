...
- Read `api/AGENTS.md` before backend work.
...
- `codex/enterprise-candidate-1.16.1-20260728` is the current clean enterprise candidate rebuilt from official tag `1.16.1`.
- The enterprise version for this candidate is `1.16.1-enterprise`.
- Enterprise images: `dify-api-enterprise:1.16.1-enterprise`, `dify-web-enterprise:1.16.1-enterprise`.
...
- The previous `enterprise/main`, `codex/enterprise-candidate-1.16.0-20260720`, `codex/enterprise-candidate-20260424`, and `D:\CodexSpace\dify-enterprise-candidate-20260424` are historical references only unless a specific patch is re-selected and validated.
